...
CREATE TABLE IF NOT EXISTS `laraveldb`.`groups` (
  ...
  `userId` INT(11) NOT NULL,
  PRIMARY KEY (`groupId`),
  INDEX `fk_groups_user1_idx` (`userId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `laraveldb`.`groupmembers` (
  ...
  INDEX `fk_user_has_groups_groups1_idx` (`groupId` ASC) VISIBLE,
  INDEX `fk_user_has_groups_user1_idx` (`userId` ASC) VISIBLE,
